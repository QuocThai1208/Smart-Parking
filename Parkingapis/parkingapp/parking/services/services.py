import math
from ..models import Vehicle, ParkingLog, ParkingStatus, FeeRule, User, FeeType, Payment, PaymentStatus, UserRole
...
def proces(plate_text: str, direction: ParkingStatus = "IN") -> tuple[bool, str]:
    ...
    ok, msg = create_parking(vehicle, vehicle.vehicle_type)
    return ok, msg
