...
from ..models import ParkingLog, ParkingStatus, User, UserRole
...
def compare_monthly_revenue(user:User, current_start: Optional[date] = None,
    ...
    current_revenue = get_total_revenue_range(user, current_start, current_end)
    prev_revenue = get_total_revenue_range(user, prev_start, prev_end)
